...
\pfshow{\input{Fried/Ch.2/thm_2-1.tex}}
...
\pfshow{\input{Fried/Ch.2/thm_2-2.tex}
...
\begin{rmk*}
The Linearity and Finite-dimensional is essential arguement.	
\end{rmk*}
...
\pfshow{\input{Fried/Ch.2/thm_2-16.tex}}
...
\pfshow{\input{Fried/Ch.2/thm_2-17_lmma.tex}}
...
\pfshow{\input{Fried/Ch.2/thm_2-18.tex}}
...
\pfshow{\input{Fried/Ch.2/thm_2-22.tex}}
...
\pfshow{\input{Fried/Ch.2/thm_2-23.tex}}
...
\pfshow{\input{Fried/Ch.2/thm_2-23_cor.tex}}
...
\pfshow{\input{Fried/Ch.2/ex_2-5-9.tex}}
...
\pfshow{\input{Fried/Ch.2/ex_2-5-10.tex}}
...
\begin{lmma}% ex 2.4 15
	Let $V$ and $W$ be finite-dimensional vector spaces, and let $T:V \rightarrow W$ be a linear transformation. Suppose that $\beta$ is a basis for $V$. Then $T$ is an isomorphism if and only if $T(\beta)$ is a basis for $W$.
\end{lmma}

\pfshow{\input{Fried/Ch.2/ex_2-4-15.tex}}
...
\pfshow{\input{Fried/Ch.2/ex_2-4-21.tex}}
...
\pfshow{\input{Fried/Ch.2/ex_2-4-20.tex}}
